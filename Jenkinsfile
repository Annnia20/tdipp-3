        ...
        success
        {
            ...
            script
            {
                if(env.ON_SUCCESS_SEND_EMAIL)
                {
                    ...
                    emailext ( body: "Success! job name: ${JOB_NAME}, build number: ${BUILD_NUMBER}, build url: ${BUILD_URL}", subject: 'Build', to: 'mereuta636@gmail.com')
                    echo 'Email sent'
                }
            }
        }
        failure
        {
            ...
            script
            {
                if(env.ON_FAILURE_SEND_EMAIL)
                {
                    ...
                    emailext ( body: "Fail! job name: ${JOB_NAME}, build number: ${BUILD_NUMBER}, build url: ${BUILD_URL}", subject: 'Build', to: 'mereuta636@gmail.com')
                    echo 'Email sent'
                }
            }
        }
